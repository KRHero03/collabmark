...
describe("UserAvatar", () => {
  ...
  it("renders img tag when url is provided", () => {
    const { container } = render(<UserAvatar url="https://example.com/avatar.png" name="John Doe" />);
  ...
  it("sets referrerPolicy='no-referrer' on the img tag", () => {
    const { container } = render(<UserAvatar url="https://example.com/avatar.png" name="Jane" />);
    const img = container.querySelector("img");
    expect(img).toHaveAttribute("referrerPolicy", "no-referrer");
  });

  it("sets correct alt text from name prop", () => {
    const { container } = render(<UserAvatar url="https://example.com/avatar.png" name="Alice Smith" />);
    const img = container.querySelector("img");
  ...
  it("shows fallback icon when url is undefined", () => {
    const { getByTestId } = render(<UserAvatar url={undefined} name="User" />);
    expect(getByTestId("avatar-fallback")).toBeInTheDocument();
  });
  ...
  it("renders correct size classes for 'sm'", () => {
    const { container } = render(<UserAvatar url="https://example.com/a.png" name="User" size="sm" />);
    const img = container.querySelector("img");
  ...
  it("renders correct size classes for 'md'", () => {
    const { container } = render(<UserAvatar url="https://example.com/a.png" name="User" size="md" />);
    const img = container.querySelector("img");
  ...
  it("renders correct size classes for 'lg'", () => {
    const { container } = render(<UserAvatar url="https://example.com/a.png" name="User" size="lg" />);
    const img = container.querySelector("img");
  ...
  it("default size is 'md' when not specified", () => {
    const { container } = render(<UserAvatar url="https://example.com/a.png" name="User" />);
    const img = container.querySelector("img");
    expect(img?.className).toContain("h-8");
    expect(img?.className).toContain("w-8");
  });
  ...
  it("applies additional className prop", () => {
    const { container } = render(<UserAvatar url="https://example.com/a.png" name="User" className="custom-class" />);
    const img = container.querySelector("img");
    expect(img?.className).toContain("custom-class");
  });

  it("applies additional className prop to fallback icon", () => {
    const { getByTestId } = render(<UserAvatar url={null} name="User" className="my-extra-class" />);
