...
describe("CreateFolderDialog", () => {
  ...
  it("renders nothing when open is false", () => {
    const { container } = render(
      <CreateFolderDialog open={false} onClose={vi.fn()} onCreate={vi.fn()} />,
    );
  ...
  it("renders dialog when open is true", () => {
    const { getByText } = render(
      <CreateFolderDialog open onClose={vi.fn()} onCreate={vi.fn()} />,
    );
  ...
  it("calls onCreate with name on submit", () => {
    ...
    const { container, getByText } = render(
      <CreateFolderDialog open onClose={onClose} onCreate={onCreate} />,
    );
    const input = container.querySelector("input") as HTMLInputElement;
  ...
  it("calls onClose when Cancel is clicked", () => {
    const onClose = vi.fn();
    const { getByText } = render(
      <CreateFolderDialog open onClose={onClose} onCreate={vi.fn()} />,
    );
  ...
  it("trims whitespace before creating", () => {
    const onCreate = vi.fn();
    const { container, getByText } = render(
      <CreateFolderDialog open onClose={vi.fn()} onCreate={onCreate} />,
    );
    const input = container.querySelector("input") as HTMLInputElement;
