...
class TestRecordView:
    ...
    @pytest.mark.asyncio
    async def test_record_view_returns_204(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_record_view_creates_document_view_record(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_record_view_records_own_document(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_record_view_updates_timestamp_on_revisit(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_record_view_nonexistent_doc_returns_403(self, async_client: AsyncClient, test_user: User):
        async_client.cookies.update(_auth_cookies(test_user))
        resp = await async_client.post("/api/documents/000000000000000000000000/view")
        assert resp.status_code == 403

    @pytest.mark.asyncio
    async def test_record_view_invalid_doc_id_returns_403(self, async_client: AsyncClient, test_user: User):
        async_client.cookies.update(_auth_cookies(test_user))
        resp = await async_client.post("/api/documents/not-a-valid-id/view")
        assert resp.status_code == 403

    @pytest.mark.asyncio
    async def test_record_view_unauthenticated_returns_401(self, async_client: AsyncClient):
        resp = await async_client.post("/api/documents/000000000000000000000000/view")
...
class TestListRecentlyViewed:
    ...
    @pytest.mark.asyncio
    async def test_empty_list_when_no_views(self, async_client: AsyncClient, test_user: User):
        async_client.cookies.update(_auth_cookies(test_user))
    ...
    @pytest.mark.asyncio
    async def test_lists_viewed_documents(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_sorted_by_most_recently_viewed(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_includes_own_documents(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_does_not_include_deleted_documents(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_does_not_include_docs_user_lost_access_to(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_shows_edit_permission_for_anyone_edit_doc(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_own_document_shows_edit_permission(self, async_client: AsyncClient, test_user: User):
        doc = await _make_doc(test_user, title="My Own Doc")
        async_client.cookies.update(_auth_cookies(test_user))
    ...
    @pytest.mark.asyncio
    async def test_explicit_collaborator_doc_appears_in_recent(self, async_client: AsyncClient, test_user: User):
    ...
    @pytest.mark.asyncio
    async def test_revisit_moves_doc_to_top(self, async_client: AsyncClient, test_user: User):
